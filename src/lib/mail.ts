...
export const sendWelcomeEmail = async (to: string, name: string) => {
    try {
        ...
        if (!process.env.EMAIL_USER || !process.env.EMAIL_PASS) {
            ...
            console.log(`Subject: Welcome to Godavari Pickles!`);
        ...
        await transporter.sendMail({
            ...
            to,
            subject: 'Welcome to Godavari Pickles! 🥒',
            html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h1 style="color: #2e7d32;">Welcome to Godavari Pickles!</h1>
          <p>Hi ${name},</p>
          <p>Thank you for joining our community of pickle lovers! We are excited to serve you the most authentic, homemade pickles from West Godavari.</p>
          ...
          <p style="margin-top: 30px; color: #666; font-size: 12px;">© ${new Date().getFullYear()} Godavari Pickles. All rights reserved.</p>
        </div>
      `,
        });
